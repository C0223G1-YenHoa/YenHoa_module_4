...
public class BlogController {
    ...
    public ResponseEntity<List<Blog>> search(@PathVariable String name,@PathVariable String title) {
        return new ResponseEntity<>(this.blogService.search(name,title), HttpStatus.OK);
    }

    @GetMapping("/load/{limited}")
    public ResponseEntity<List<Blog>> load(@PathVariable int limited){
        return new ResponseEntity<>(this.blogService.page(limited),HttpStatus.OK);
    }
}
